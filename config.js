...
global.packname = process.env.PACK_NAME === undefined ? 'KINGDDOM ZEUS ' : process.env.PACK_NAME
global.author = process.env.STICKER_AUTHOR_NAME === undefined ? 'PIUSHA' : process.env.STICKER_AUTHOR_NAME
